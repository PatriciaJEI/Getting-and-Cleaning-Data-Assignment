...
This code book contains an explanation of he variable names and an explanation of the code used to obtain the final data set containing 
those variables, to give the follwed steps to cleaning and tidying the data from the "UCI HAR Dataset" folder.
